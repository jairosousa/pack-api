...
public class UsuarioController {
    ...
    @Operation(summary = "Atualizar senha", description = "Recurso para atualizar a senha do usuario",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Recurso não encontrado",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))),
                    @ApiResponse(responseCode = "422", description = "Compos Invalidos ou mal formatados",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class)))
    ...
    @Operation(summary = "Obter todos os usuários", description = "Listar todos usuários cadastrados",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Listar todos usuários cadastrados",
